...
<div class="page-breadcrumb">
    <div class="row">
        <div class="col-12 d-flex no-block align-items-center">
            <h4 class="page-title">Ubah Bukti Transfer</h4>
            <div class="ml-auto text-right">
                <nav aria-label="breadcrumb">
                    <ol class="breadcrumb">
                        <li class="breadcrumb-item"><a href="{{ url('/home') }}">Home</a></li>
                        <li class="breadcrumb-item active" aria-current="page">Ubah Bukti Transfer</li>
                    </ol>
                </nav>
            </div>
        </div>
...
<form action="{{ url('transfer/'.$data->id) }}" method="POST" enctype="multipart/form-data" id="identifier">
    @csrf
    ...
    <div class="container-fluid">
        <div class="row">
            <div class="col-12">
                <div class="card">
                    <div class="card-body">
                        <h5 class="card-title">Ubah Bukti Transfer</h5><hr>

                        
                        <div class="form-group">
                            <label for="gambar" class="form-control-label">Foto</label>
                            <input type="file" name="gambar" value="{{ old('gambar') ? old('gambar') : $data->gambar }}" accept="image/*" class="form-control @error('gambar') is-invalid @enderror "  />
