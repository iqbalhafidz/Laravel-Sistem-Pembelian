...
<div class="container-fluid">
    <div class="row">
        <div class="col-12">
            <div class="card">
                <div class="card-body">
                    <a href="{{route('transfer.create')}}" class=" btn-priamry btn-sm">
                                ...
                                @foreach ($data as $item =>$value)
                                    <tr>
                                        ...
                                        <Td>
                                            ...
                                            <a href="{{route('transfer.edit', $value->id)}}" class=" btn-priamry btn-sm">
                                                <button class="btn btn-primary btn-sm" >Ubah</button>
                                            </a>|

                                            <form action="{{ route('transfer.destroy', $value->id) }}"  method="POST" class="d-inline">
                                                @csrf
                                                @method('delete')
